...
| Master: | !https://travis-ci.org/twasyl/SlideshowFX.svg?branch=master!:https://travis-ci.org/twasyl/SlideshowFX !https://ci.appveyor.com/api/projects/status/i6mrl8ggqb3e3uod/branch/master?svg=true!:https://ci.appveyor.com/project/twasyl/slideshowfx-clkh2 |
| Development: | !https://travis-ci.org/twasyl/SlideshowFX.svg?branch=development!:https://travis-ci.org/twasyl/SlideshowFX !https://ci.appveyor.com/api/projects/status/i6mrl8ggqb3e3uod/branch/development?svg=true!:https://ci.appveyor.com/project/twasyl/slideshowfx-clkh2 |
...
* A JDK 8 update 131 ;
* The @JAVA_HOME@ system variable set to point to you JDK 8 update 131 installation.
